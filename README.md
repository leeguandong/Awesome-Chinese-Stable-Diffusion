...
<a href="https://star-history.dera.page/#leeguandong/Awesome-Chinese-Stable-Diffusion&Date">

  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="https://star-history.dera.page/svg?repos=leeguandong/Awesome-Chinese-Stable-Diffusion&type=Date&theme=dark" />
    <source media="(prefers-color-scheme: light)" srcset="https://star-history.dera.page/svg?repos=leeguandong/Awesome-Chinese-Stable-Diffusion&type=Date" />
    <img alt="Star History Chart" src="https://star-history.dera.page/svg?repos=leeguandong/Awesome-Chinese-Stable-Diffusion&type=Date" />
  </picture>
